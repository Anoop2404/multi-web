...
class FestEvent extends Model
{
    ...
    protected $fillable = [
        ...
        'registration_open', 'registration_close', 'event_start', 'event_end', 'certificate_date', 'sports_age_cutoff_date', 'venue',
        'fee_type', 'fee_amount', 'fee_settings', 'numbering_settings', 'status', 'nav_hidden', 'results_published', 'tv_show_overall_standings', 'description',
