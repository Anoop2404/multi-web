...
class ReportRegistry
{
    ...
    private static function sportsReports(string $base): array
    {
        ...
        return [
            ...
            self::row('RPT-SPT-013', 'Eligibility exception log', 'sports', 'retain', self::runnerHref($base, 'RPT-SPT-013'), null, true),
            self::row('RPT-SPT-014', 'Absentee list', 'sports', 'retain', $events, 'Event → Attendance export'),
            self::row('RPT-SPT-015', 'Event Head wise summary', 'sports', 'retain', $events, 'Event → Head-wise participants'),
            ...
            self::row('RPT-SPT-023', 'Venue utilization', 'sports', 'retain', self::runnerHref($base, 'RPT-SPT-023'), null, true),
            self::row('RPT-SPT-024', 'Registration window status', 'sports', 'retain', self::runnerHref($base, 'RPT-SPT-024'), null, true),
            self::row('RPT-SPT-025', 'Free vs paid item breakdown', 'sports', 'retain', $events, 'Event → Fee collection'),
            ...
            self::row('RPT-SPT-042', 'Record broken log', 'sports', 'retain', "{$base}/sports/records"),
