...
class SchoolWebsiteTemplateCatalog
{
    /** @return array<string, array<string, mixed>> */
    public static function all(): array
    {
        return config('school_website_templates', []);
    }
    ...
    public static function get(string $key): array
    {
        ...
        if (! is_array($template)) {
            throw new InvalidArgumentException("Unknown School website template [{$key}].");
        }

        SahodayaWebsiteTemplateValidator::validate($key, $template, SchoolSiteBuilderCatalog::class);
