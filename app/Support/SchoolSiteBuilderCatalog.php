...
class SchoolSiteBuilderCatalog
{
    ...
    public const SECTION_TYPES = [
        'hero' => ['centered', 'split-image', 'video-bg', 'minimal', 'with-quicklinks', 'full-bleed', 'full-slider'],
        'about' => ['text-left', 'text-right', 'two-column', 'with-motto', 'vision-mission', 'split-image', 'overlap-stats'],
        'principal_message' => ['card-style', 'full-width', 'with-management', 'split-portrait'],
        'management' => ['photo-cards', 'table-list'],
        'statistics' => ['counter-cards', 'horizontal-strip', 'counter-strip', 'with-achievements'],
        'facilities' => ['icon-grid', 'image-cards', 'with-virtual-tour', 'why-choose-cards'],
        'academic_programmes' => ['tabs', 'cards', 'with-results'],
        'staff' => ['photo-grid', 'table-list', 'department-tabs', 'card-grid'],
        'news' => ['grid', 'list', 'ticker', 'featured-plus-list', 'featured-strip'],
        'events' => ['card-grid', 'timeline', 'list'],
        'gallery' => ['masonry-grid', 'carousel', 'album-based', 'grid', 'preview-grid'],
        'video_gallery' => ['youtube-grid', 'featured-embed'],
        'board_results' => ['toppers-cards', 'stats-plus-toppers', 'year-tabs'],
        'achievements' => ['cards', 'timeline', 'badge-wall', 'horizontal-scroll'],
        'mandatory_disclosure' => ['structured', 'accordion'],
        'admissions' => ['info-block', 'with-form', 'fee-structure', 'promo-block'],
        ...
        'contact' => ['stacked', 'with-whatsapp', 'centered-card'],
