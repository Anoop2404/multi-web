...
class FestReportCatalog
{
    ...
    public static function exports(string $tenantId, int $eventId): array
    {
        ...
        $exports = [
            ...
            ['id' => 'category-totals-pdf', 'label' => 'Category-wise Totals (PDF)', 'format' => 'pdf', 'params' => [], 'phase' => 'after', 'audience' => 'staff'],
            ['id' => 'individual-championship-xls', 'label' => 'Individual Championship — Category & Gender wise (Excel)', 'format' => 'xls', 'params' => [], 'phase' => 'after', 'audience' => 'staff'],
            ['id' => 'individual-championship-pdf', 'label' => 'Individual Championship — Category & Gender wise (PDF)', 'format' => 'pdf', 'params' => [], 'phase' => 'after', 'audience' => 'staff'],
    ...
    private const SCOPE_METADATA = [
        ...
        'student-wise-pdf'              => ['dataset' => 'registration', 'supported_scopes' => ['self', 'combined', 'region'], 'supports_competition_phase' => true],
        ...
        'category-totals-pdf'          => ['dataset' => 'results', 'supported_scopes' => ['self', 'combined', 'region'], 'supports_competition_phase' => false],
        'individual-championship-xls'   => ['dataset' => 'results', 'supported_scopes' => ['self', 'combined', 'region'], 'supports_competition_phase' => false],
        'individual-championship-pdf'   => ['dataset' => 'results', 'supported_scopes' => ['self', 'combined', 'region'], 'supports_competition_phase' => false],
    ...
    public static function interactivePages(string $tenantId, int $eventId, ?string $eventType = null): array
    {
        ...
        $pages = [
            ...
            ['id' => 'championship', 'label' => 'Individual Championship', 'href' => "{$base}/championship"],
    ...
    public static function previewPageForExport(string $exportId): ?string
    {
        return match ($exportId) {
            ...
            'student-wise-report', 'student-wise-pdf' => 'student-wise',
