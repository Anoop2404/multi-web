...
class CertificateTemplateController extends SahodayaAdminController
{
    ...
    public function store(Request $request)
    {
        $data = $request->validate([
            ...
            'layout_json.signature_blocks.*.label'         => 'nullable|required_with:layout_json.signature_blocks.*.name_text,layout_json.signature_blocks.*.designation_text,layout_json.signature_blocks.*.school_text,layout_json.signature_blocks.*.signature_file|string|max:80',
            ...
            'layout_json.signature_blocks.*.signature.font_size'  => 'nullable|numeric|min:6|max:96',
            'layout_json.signature_blocks.*.signature.font_family' => ['nullable', 'string', Rule::in(CertificateTemplate::fontFamilyOptions())],
            'layout_json.signature_blocks.*.signature.font_weight' => 'nullable|in:normal,bold',
            'layout_json.signature_blocks.*.signature.font_style' => 'nullable|in:normal,italic',
            'layout_json.signature_blocks.*.signature.align'      => 'nullable|in:left,right,center,none,justify',
            'layout_json.signature_blocks.*.name.top'        => 'nullable|numeric|min:0|max:100',
            'layout_json.signature_blocks.*.name.left'       => 'nullable|numeric|min:0|max:100',
            'layout_json.signature_blocks.*.name.width'      => 'nullable|numeric|min:0|max:100',
            'layout_json.signature_blocks.*.name.font_size'  => 'nullable|numeric|min:6|max:96',
            'layout_json.signature_blocks.*.name.font_family' => ['nullable', 'string', Rule::in(CertificateTemplate::fontFamilyOptions())],
            'layout_json.signature_blocks.*.name.font_weight' => 'nullable|in:normal,bold',
            'layout_json.signature_blocks.*.name.font_style' => 'nullable|in:normal,italic',
            'layout_json.signature_blocks.*.name.align'      => 'nullable|in:left,right,center,none,justify',
            'layout_json.signature_blocks.*.designation.top'        => 'nullable|numeric|min:0|max:100',
            'layout_json.signature_blocks.*.designation.left'       => 'nullable|numeric|min:0|max:100',
            'layout_json.signature_blocks.*.designation.width'      => 'nullable|numeric|min:0|max:100',
            'layout_json.signature_blocks.*.designation.font_size'  => 'nullable|numeric|min:6|max:96',
            'layout_json.signature_blocks.*.designation.font_family' => ['nullable', 'string', Rule::in(CertificateTemplate::fontFamilyOptions())],
            'layout_json.signature_blocks.*.designation.font_weight' => 'nullable|in:normal,bold',
            'layout_json.signature_blocks.*.designation.font_style' => 'nullable|in:normal,italic',
            'layout_json.signature_blocks.*.designation.align'      => 'nullable|in:left,right,center,none,justify',
            'layout_json.signature_blocks.*.school.top'        => 'nullable|numeric|min:0|max:100',
            'layout_json.signature_blocks.*.school.left'       => 'nullable|numeric|min:0|max:100',
            'layout_json.signature_blocks.*.school.width'      => 'nullable|numeric|min:0|max:100',
            'layout_json.signature_blocks.*.school.font_size'  => 'nullable|numeric|min:6|max:96',
            'layout_json.signature_blocks.*.school.font_family' => ['nullable', 'string', Rule::in(CertificateTemplate::fontFamilyOptions())],
