...
class FestEventSettingsController extends SahodayaAdminController
{
    ...
    public function updateFeeSettings(Request $request, string $tenantId, FestEvent $event)
    {
        ...
        $data = $request->validate([
            ...
            'id_card_downloads_disabled' => 'nullable|boolean',
        ...
        $feeSettings = array_merge(
            ...
            array_filter([
                ...
                'id_card_downloads_disabled' => array_key_exists('id_card_downloads_disabled', $data)
                    ? (bool) $data['id_card_downloads_disabled'] : null,
