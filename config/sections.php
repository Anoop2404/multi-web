    ...
    'hero' => [
        ...
        'gradient-split' => [
            ...
            'fields' => [
                ...
                ['key' => 'show_search',  'type' => 'switch', 'label' => 'Show search bar', 'default' => true],
                ['key' => 'show_stats',   'type' => 'switch', 'label' => 'Show stat cards', 'default' => true],
                ['key' => 'secondary_text', 'type' => 'textarea', 'label' => 'Additional Text (optional — shown below search/stats, or in their place if hidden)'],
                ['key' => 'cta_label',    'type' => 'text', 'label' => 'Button Label (optional)'],
                ['key' => 'cta_url',      'type' => 'url',  'label' => 'Button URL (optional)'],
                ['key' => 'autoplay_seconds', 'type' => 'number', 'label' => 'Slide Duration (seconds)', 'default' => 3],
                ['key' => 'slides',       'type' => 'repeater', 'label' => 'Photo / Video Slides — each is a standalone slide with its own heading, replacing the search/stats while shown',
                 'fields' => [
                     ...
                     ['key' => 'eyebrow',   'type' => 'text',  'label' => 'Eyebrow Label (optional)'],
                     ['key' => 'title',     'type' => 'text',  'label' => 'Slide Headline', 'required' => true],
                     ['key' => 'caption',   'type' => 'text',  'label' => 'Slide Description (optional)'],
                     ['key' => 'cta_label', 'type' => 'text',  'label' => 'Button Label (optional)'],
                     ['key' => 'cta_url',   'type' => 'url',   'label' => 'Button URL (optional)'],
                 ]],
            ],
    ...
    'mandatory_disclosure' => [
        'structured' => [
            ...
            'fields' => [
                ...
                ['key' => 'download_label',     'type' => 'text',  'label' => 'Document Link Label'],
                ...
                ['key' => 'udise_code',         'type' => 'text',  'label' => 'UDISE Code'],
    ...
    'contact' => [
        ...
        'centered-card' => [
            ...
            'fields' => [
                ...
                ['key' => 'phone_label',  'type' => 'text', 'label' => 'Phone Label'],
                ['key' => 'email_label',  'type' => 'text', 'label' => 'Email Label'],
                ['key' => 'address_label','type' => 'text', 'label' => 'Address Label'],
