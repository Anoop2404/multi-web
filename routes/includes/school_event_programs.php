...
foreach ($festPrograms as $cfg) {
    ...
    Route::prefix($prefix)->name("{$prefix}.")->middleware(EnsureSchoolFestProgramMatchesEvent::class)->group(function () use ($controller, $slug, $prefix) {
        ...
        Route::get('/reports/{event}/student-limits', [FestSchoolReportController::class, 'studentLimits'])
            ->defaults('program', $slug)
            ->name('reports.student-limits');
        Route::get('/reports/{event}/student-limits/export', [FestSchoolReportController::class, 'exportStudentLimits'])
            ->defaults('program', $slug)
            ->name('reports.student-limits.export');
        Route::get('/reports/{event}/student-limits/pdf', [FestSchoolReportController::class, 'exportStudentLimitsPdf'])
            ->defaults('program', $slug)
            ->name('reports.student-limits.pdf');
        ...
        Route::get('/reports/{event}/item-wise/marks-pdf', [FestSchoolReportController::class, 'itemWisePdf'])
            ->defaults('program', $slug)
            ->name('reports.item-wise.marks-pdf');
        ...
        Route::get('/reports/{event}/student-report', [FestSchoolReportController::class, 'studentReport'])
            ->defaults('program', $slug)
            ->name('reports.student-report');
        ...
        Route::get('/reports/{event}/id-cards/preview', [FestSchoolReportController::class, 'idCardsPreview'])
            ->defaults('program', $slug)
            ->name('reports.id-cards.preview');
