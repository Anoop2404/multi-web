...
Route::middleware([
    ...
    // Impersonation handoff (FRD-13 Â§12) â€”€” see ImpersonationService's docblock for why this
    ...
    // Question bank downloads (always available on Sahodaya tenants â€” not gated by the
