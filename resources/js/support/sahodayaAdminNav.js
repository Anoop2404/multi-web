    ...
    return [
        ...
        },
        {
            ...
            items: [
                ...
                { label: 'Class X Board Results', href: `${base}/board-results/verification?class=10`, icon: 'bar-chart' },
                { label: 'Class XII Board Results', href: `${base}/board-results/verification?class=12`, icon: 'bar-chart' },
                { label: 'School-Certified Result Packages', href: `${base}/board-results/certifications`, icon: 'shield' },
                { label: 'Board Result Reports', href: `${base}/board-results/reports`, icon: 'bar-chart' },
                { label: 'Subject-Wise Toppers', href: `${base}/board-results/reports/subject-merit`, icon: 'star' },
                { label: 'Full A1 Achievers', href: `${base}/board-results/reports/full-a1-achievers`, icon: 'star' },
                { label: 'Sahodaya Toppers', href: `${base}/board-results/toppers`, icon: 'award' },
                { label: 'Subject Master', href: `${base}/board-results/masters`, icon: 'layers' },
                { label: 'Board Results Settings', href: `${base}/board-results/settings`, icon: 'settings' },
    ...
    return [
        ...
        },
        {
            ...
            items: [
                ...
                { label: 'Registration report', href: `${examBase}/reports/registration`, icon: 'clipboard' },
                { label: 'Class-wise counts', href: `${examBase}/reports/class-wise-counts`, icon: 'bar-chart' },
                { label: 'Fee summary report', href: `${examBase}/reports/fees`, icon: 'credit-card' },
                { label: 'Attendance sheet report', href: `${examBase}/reports/attendance`, icon: 'users' },
