...
export const SCHOOL_EVENT_REPORTS = [
    ...
    { id: 'head-wise', label: 'Participant list (by head)', category: 'heads', phase: 'before', hasPreview: true, hasExport: true, pdfExportSuffix: 'head-wise/pdf', icon: '👥', hint: 'Students with photo, reg no, fest ID, chest and item details', featured: true, program: 'sports-meet' },
    ...
    { id: 'student-limits', label: 'Student item limits', category: 'registration', phase: 'before', hasPreview: true, hasExport: true, exportSuffix: 'student-limits/export', exportLabel: 'CSV', icon: '🚦', hint: 'Per-student on-stage / off-stage / individual & group limit usage', featured: true },
    ...
    { id: 'discipline-participation', label: 'Discipline breakdown', category: 'registration', phase: 'before', hasPreview: true, hasExport: true, pdfExportSuffix: 'discipline-participation/pdf', icon: '🏃', hint: 'Registrations by sport discipline', featured: true, program: 'sports-meet' },
    ...
    { id: 'attendance', label: 'Attendance register', category: 'schedule', phase: 'before', hasPreview: true, hasExport: true, pdfExportSuffix: 'attendance-sheet', icon: '✅', hint: 'Students with photos — filter by head/item, print sheet', featured: true },
    { id: 'attendance-sheet', label: 'Attendance sheet (PDF only)', category: 'schedule', phase: 'before', hasPreview: false, hasExport: true, pdfExportSuffix: 'attendance-sheet', icon: '📄', hint: 'Quick PDF download without preview' },
    ...
    { id: 'student-wise', label: 'Student-wise results', category: 'competition', phase: 'after', hasPreview: true, hasExport: true, pdfExportSuffix: 'student-wise/pdf', exportSuffix: 'student-wise/export', exportLabel: 'CSV', icon: '🎓', hint: 'Results for each student' },
