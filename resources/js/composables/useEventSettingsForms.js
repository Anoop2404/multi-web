...
export function useEventSettingsForms(props) {
    ...
    const feeSettingsForm = useForm({
        ...
        sport_event_fees: {
            school_registration_fee: props.event.school_registration_fee ?? '',
            student_registration_fee: props.event.student_registration_fee ?? '',
            team_registration_fee: props.event.team_registration_fee ?? '',
            default_item_fee: props.event.default_item_fee ?? '',
            extra_item_fee: props.event.extra_item_fee ?? '',
            included_items_per_student: props.event.included_items_per_student ?? 0,
            included_teams: props.event.included_teams ?? 0,
            verification_policy: props.event.verification_policy ?? 'all_students',
