<template>
    <SchoolAdminLayout :title="`Edit: ${event.title}`" :school="school">
        <div class="max-w-2xl">
            <form @submit.prevent="submit" class="space-y-5">
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 space-y-5">
                    ...
                    <div>
                        <label class="block text-xs font-semibold text-gray-600 mb-1.5">{{ event.image ? 'Replace Image' : 'Event Image' }}</label>
