<template>
    <SchoolAdminLayout title="Register by Sport Event" :school="school" :show-header-title="false">
        <PageHeader
            title="Register by Sport Event"
            eyebrow="Sports Meet · Step 2"
            description="Choose which sports fest, then pick a sport event to register athletes for its items."
        >
            <template #actions>
