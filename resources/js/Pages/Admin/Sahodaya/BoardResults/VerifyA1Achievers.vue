<template>
    <SahodayaAdminLayout :title="pageTitle" :sahodaya="sahodaya" :publicUrl="publicUrl" :show-header-title="false">
        <PageHeader :title="pageTitle" eyebrow="Academic Results"
            ...
            <template #actions>
                <a :href="`/sahodaya-admin/${sahodaya.id}/board-results/verification/a1/export?class=${selectedClass}&status=${filters.status}`" target="_blank" class="btn-secondary text-sm">📊 Excel</a>
