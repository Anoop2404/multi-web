<template>
    <SahodayaEventsLayout :title="`${event.title} — Student item limits`" :sahodaya="sahodaya" :event="event"
        ...
        <ReportsSubNav :sahodaya-id="sahodaya.id" :event-id="event.id" active="student-limits" />
                ...
                <div class="px-5 py-3.5 bg-slate-50/90 border-b border-slate-200 flex flex-wrap items-center justify-between gap-3">
                    <div class="flex items-center gap-3">
                        ...
                        <h4 class="font-bold text-slate-900 text-base flex items-center gap-2 flex-wrap">
                            ...
                            <span v-if="st.school_name" class="text-xs font-normal text-slate-400">· {{ st.school_name }}</span>
