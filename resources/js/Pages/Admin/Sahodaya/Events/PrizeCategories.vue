<template>
    <AdminLayout :title="`Prize categories — ${event.title}`">
        ...
        <section class="card">
            ...
            <p v-if="!categories.length" class="py-8 text-center text-sm text-slate-400">
                ...
                or an overall championship across everything.
            </p>
        ...
        <section v-for="s in standings" :key="s.category.id" class="card">
            ...
            <div class="grid gap-4 lg:grid-cols-2">
                <div v-for="kind in ['individual', 'school']" :key="kind">
...
const props = defineProps({
    event: Object, categories: Array, standings: Array,
    awardTypes: Object, items: Array, actionUrls: Object,
});
