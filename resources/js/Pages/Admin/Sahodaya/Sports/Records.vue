<template>
    <SahodayaEventsLayout title="Athletic records" :sahodaya="sahodaya" :publicUrl="publicUrl"
        ...
        <section class="card card--flush overflow-hidden mb-6">
            ...
            <p v-if="!records.length" class="p-6 text-sm text-slate-500">No athletic records configured yet.</p>
        </section>
        ...
        <section class="card card--flush overflow-hidden">
            ...
            <p v-if="!recentBreaks.length" class="p-6 text-sm text-slate-500">No record breaks logged this season.</p>
        </section>
