            ...
            <div class="login-page-inner">
                ...
                <div class="login-shell">
                    ...
                    <div class="login-brand">
                        ...
                        <div class="login-badge">Member school portal</div>
                        <h1 class="login-title">{{ tenantName || 'School Login' }}</h1>
                        <p class="login-subtitle">
                            Sign in to register students for Kalotsav, sports meet, training, and annual Sahodaya membership.
                        </p>
                    ...
                    <div class="login-form-panel">
                        <div class="login-form-inner">
                            <div class="login-form-intro">
                                <p class="login-form-heading">Member school</p>
                                <h2 class="login-form-title">School Login</h2>
                                <p class="login-form-sub">Use the credentials sent when your school membership was approved.</p>
                            </div>
                            ...
                            <form @submit.prevent="submit" class="login-form">
                                ...
                                <button type="submit" :disabled="form.processing" class="login-btn">
                                    {{ form.processing ? 'Signing in…' : 'Sign in to register' }}
                                </button>
                            </form>

                            <p v-if="showRegisterLink" class="login-alt mt-5 text-center text-sm text-slate-500">
                                Not a member yet?
                                <a href="/school-register" class="font-semibold text-[#1e5aa8] hover:underline">Apply for school registration</a>
                            </p>
                ...
                <p class="login-footer-note">CBSE Sahodaya · Member schools register students &amp; submit annual data here</p>
            </div>
        </div>
    </div>
</template>
