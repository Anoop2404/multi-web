            ...
            <div class="login-page-inner max-w-md mx-auto">
                ...
                <div class="login-form-panel rounded-2xl shadow-xl">
                    <div class="login-form-inner">
                        <h2 class="login-form-title mb-2">Choose new password</h2>
                        <p class="login-form-sub mb-6">Enter your new password below.</p>

                        <form @submit.prevent="submit" class="login-form">
                            <div>
                                <label class="login-label" for="email">Email</label>
                                <input id="email" v-model="form.email" type="email" required readonly class="login-input bg-slate-50" />
                            </div>
                            <div>
                                <label class="login-label" for="password">New password</label>
                                <input id="password" v-model="form.password" type="password" required autocomplete="new-password" class="login-input" />
                            ...
                            <div>
                                ...
                                <input id="password_confirmation" v-model="form.password_confirmation" type="password" required autocomplete="new-password" class="login-input" />
                            </div>
