/**
 * Shared stroke-icon set (Feather-derived path data) for every admin/portal
 * sidebar in the app — superadmin, state-admin, Sahodaya-admin, school-admin.
 * Single canonical source; render via SvgIcon.vue rather than copying paths.
 */
