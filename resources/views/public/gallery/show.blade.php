    ...
    <div class="max-w-6xl mx-auto">
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <button type="button"
                ...
                <img loading="lazy" src="{{ $item->image_url }}" alt="{{ $item->caption ?: $album->title }}"
        ...
        @else
        <p class="text-gray-500 text-center py-12">{{ data_get($siteContent ?? [], 'pages.gallery.empty_album_message', 'This album has no photos yet.') }}</p>
        @endif
    </div>
</section>
@endsection
