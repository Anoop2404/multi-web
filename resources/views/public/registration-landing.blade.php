        ...
        <div class="portal-shell">
            ...
            <div class="portal-panel">
                ...
                <div class="portal-actions">
                    @if($isSahodaya)
                    <a href="/school-register" class="portal-action portal-action-primary">
                        ...
                        <span class="portal-action-body">
                            <span class="portal-action-title">School Registration</span>
                        </span>
                        <span class="portal-action-arrow">→</span>
                    </a>
                    @endif

                    <a href="/login" class="portal-action portal-action-secondary">
                        <div class="portal-action-icon">
                        ...
                        <span class="portal-action-body">
                            <span class="portal-action-title">Admin Login</span>
                        </span>
                        <span class="portal-action-arrow">→</span>
                    </a>
                </div>
