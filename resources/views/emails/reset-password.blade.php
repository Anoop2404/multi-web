...
@section('content')
    <h2 style="margin:0 0 12px;font-size:18px;color:#041525;font-weight:700;">Reset your password</h2>
    ...
    <p>
        ...
        @if(!empty($schoolName))
            <strong>{{ $schoolName }}</strong> portal account with <strong>{{ $sahodayaName }}</strong>.
        @else
            <strong>{{ $sahodayaName }}</strong> portal account.
        @endif
    </p>
