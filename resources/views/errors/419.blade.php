...
<body>
    <div class="error-card">
        <span class="error-code">Error 419</span>
        <h1 class="error-title">Session expired</h1>
        <p class="error-message">Your session has expired. Please sign in again to continue.</p>
        <a href="{{ url('/login') }}" class="error-btn">Go to login</a>
    </div>
</body>
</html>
