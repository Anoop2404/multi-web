...
<style>body{font-family:DejaVu Sans,sans-serif;font-size:11.5px}table{width:100%;border-collapse:collapse}th{background:#1d3557;color:#fff;padding:5px 6px;font-size:11.5px}td{border:1px solid #ccc;padding:5px 6px;font-size:11px}</style>
</head><body>
