...
<style>body{font-family:DejaVu Sans,sans-serif;font-size:11.5px}h2{text-align:center}table{width:100%;border-collapse:collapse}th,td{border:1px solid #ccc;padding:5px 6px;font-size:11px}th{background:#f3f4f6;font-size:11.5px}</style>
</head><body>
