...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .section-banner { background: #0f3d7a; color: #ffffff; padding: 6px 8px; font-size: 10px; font-weight: 700; border-radius: 3px; margin-top: 14px; margin-bottom: 6px; page-break-inside: avoid; }
        ...
        .rank-col { width: 30px; text-align: center; font-weight: bold; }
        ...
        .marks-col { font-weight: bold; color: #166534; text-align: center; font-size: 10px; }
    </style>
</head>
<body>
        ...
        <table>
            <tr>
                ...
                <td style="vertical-align:middle;">
                    ...
                    <div class="tag">Academic Board Results · Class X & Class XII Stream-Wise Toppers Report</div>
                </td>
    ...
    <div class="title">Sahodaya Board Result Toppers Register</div>
    <div class="meta-line">
        Official Top-N toppers auto-computed across all member schools.
    </div>
