...
<section class="py-16 px-4" style="background-color: color-mix(in srgb, var(--color-primary) 4%, white)">
    <div class="max-w-7xl mx-auto rounded-2xl overflow-hidden shadow-sm grid md:grid-cols-2"
         style="background: linear-gradient(135deg, color-mix(in srgb, var(--color-primary) 8%, white), color-mix(in srgb, var(--color-accent) 5%, white))">
        <div class="p-8 md:p-12 flex flex-col justify-center">
            ...
            <h3 class="text-lg font-semibold mb-4" style="color: var(--color-accent)">{{ $config['subtitle'] }}</h3>
            @endif
            ...
            <ul class="mb-6 space-y-2">
                ...
                <li class="flex items-baseline gap-3 text-sm">
                    <span class="font-bold shrink-0" style="color: var(--color-accent)">{{ $date['date'] ?? '' }}</span>
        ...
        <div class="min-h-[320px] md:min-h-full">
            ...
            <div class="w-full h-full flex items-center justify-center"
                 style="background: linear-gradient(135deg, var(--color-accent) 0%, color-mix(in srgb, var(--color-accent) 72%, #111827) 100%)">
