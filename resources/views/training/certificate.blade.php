    ...
    <div class="page has-background" style="background-image:url('{{ $backgroundUrl }}');">
        ...
        @if($showRecipientName)
            ...
            <div class="overlay-field recipient"
                 style="{{ \App\Models\CertificateTemplate::overlayFieldStyle($r, ['top' => 38, 'left' => 10, 'width' => 80, 'font_size' => 24, 'font_family' => 'Montserrat', 'font_weight' => 'bold']) }}">
        ...
        <div class="overlay-field body"
             style="{{ \App\Models\CertificateTemplate::overlayFieldStyle($b, ['top' => 48, 'left' => 12, 'width' => 76, 'font_size' => 12.5, 'font_family' => 'Montserrat']) }}">
        ...
        @if($showCertificateDate)
            ...
            @endphp
            <div class="overlay-field"
                 style="{{ \App\Models\CertificateTemplate::overlayFieldStyle($d, ['top' => 72, 'left' => 8, 'width' => 42, 'font_size' => 12, 'font_family' => 'Montserrat', 'align' => 'left']) }}">
                @if($boldVariables)
