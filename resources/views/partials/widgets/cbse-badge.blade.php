@php
    ...
    $badgeLabel = data_get($navConfig ?? [], 'portal_cta.cbse_label', 'CBSE');
@endphp
@if($show)
<div class="fixed right-0 top-1/2 -translate-y-1/2 z-50">
    <a href="/disclosure"
       ...
       aria-label="CBSE Affiliated — view mandatory public disclosure">
        <span class="font-extrabold text-sm tracking-wide leading-none [writing-mode:vertical-rl] rotate-180">{{ strtoupper($badgeLabel) }} AFFILIATED</span>
        @if($affNo)
