...
- **Topper caps & ranking rules** (currently `TopperCountConfig`, edited from three places per §1.4): Top-N, tie-break mode, rank style — per class, per stream, per subject.
